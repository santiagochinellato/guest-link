  ...
  return (
    <div ref={qrRef} className={containerStyles}>
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-black/10 rounded-full blur-3xl translate-y-1/3 -translate-x-1/3" />
      </div>

      <div className="relative z-10 w-full h-full flex flex-col p-12 text-white">
        {isHorizontal ? (
          // Horizontal Grid
          <div className="flex-1 grid grid-cols-2 gap-12 items-center">
            <div className="text-left pl-4 border-r border-white/10 pr-4 h-full flex flex-col justify-center">
              <div className="bg-white/10 backdrop-blur-md border border-white/20 px-4 py-2 rounded-lg self-start mb-8">
              ...
              <p className="text-xl text-white/90 font-medium leading-relaxed mb-auto opacity-80">
            ...
            <div className="flex flex-col items-center justify-center">
              <div className="p-6 bg-white rounded-[2rem] shadow-2xl transform hover:scale-[1.02] transition-transform duration-500">
                <QrCode
          ...
          <>
            <div className="flex justify-between items-start mb-12">
              ...
              {branding.logo && (
                <div className="w-16 h-16 rounded-full border-2 border-white/30 overflow-hidden bg-white">
            ...
            <div className="text-center flex-1 flex flex-col items-center justify-center">
              ...
              <p className="text-xl text-white/90 font-medium max-w-lg leading-relaxed mb-12">
                {content.welcomeMessage}
              </p>

              <div className="p-4 bg-white rounded-3xl shadow-2xl transform">
                <QrCode
                  url={content.guideUrl}
                  branding={branding}
                  primaryColor={design.primaryColor}
            ...
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 flex flex-col md:flex-row items-center justify-around gap-6 mt-8">
