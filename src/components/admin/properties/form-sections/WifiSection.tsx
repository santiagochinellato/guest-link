  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4 p-6 bg-gray-50 dark:bg-neutral-800/20 rounded-2xl border border-gray-100 dark:border-neutral-800">
          ...
          <div>
            ...
            <input
              ...
              className="w-full mt-1 px-4 py-3 rounded-xl border border-gray-200 dark:border-neutral-700 bg-white dark:bg-white/5 outline-none focus:border-brand-copper transition-all"
            />
            z
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full mt-1 px-4 py-3 rounded-xl border border-gray-200 dark:border-neutral-700 bg-white dark:bg-white/5 outline-none focus:border-brand-copper font-mono transition-all"
            />
          </div>
          ...
          <button
            ...
            className="w-full py-3 bg-white dark:bg-neutral-800 border border-brand-void/30 text-brand-void rounded-xl font-bold hover:bg-brand-void/5 transition-colors flex items-center justify-center gap-2 dark:text-brand-copper dark:border-brand-copper/30 dark:bg-brand-copper/5"
          >
        ...
        <div className="space-y-4 p-6 bg-brand-void/5 dark:bg-brand-copper/5 rounded-2xl border border-brand-copper/10 flex flex-col justify-start">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <Link2 className="w-5 h-5 text-brand-copper" />
              <span className="font-bold">Link de Invitados</span>
            </div>
            <p className="text-sm text-brand-void dark:text-white mb-4">
          ...
          <button
            ...
            className="w-full py-3 dark:bg-brand-copper/80 bg-brand-void text-white rounded-xl font-bold hover:opacity-90 transition-opacity shadow-lg shadow-brand-copper/20 flex items-center justify-center gap-2"
          >
            <QrCode className="w-4 h-4" />
            Generar QR de Acceso
          </button>
          {/* Preview Section */}
          <div className="p-4 bg-transparent dark:bg-amber-900/10 border border-brand-void-100 dark:border-amber-900/30 rounded-xl">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h4 className="text-sm font-bold text-brand-void dark:text-white">
                  Cadena QR Actual
                </h4>
                ...
                {wifiQrCode && (
                  <p className="text-[12px] mt-2 text-brand-void dark:text-amber-400 font-semibold ">
                    Esta es la cadena que se imprimirá en el flyer y se
                    compartirá con los huéspedes.
                  </p>
                )}
              </div>
            </div>
